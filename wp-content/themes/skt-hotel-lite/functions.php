...
define('SKT_URL','http://www.studio4net.com');
define('SKT_THEME_URL','http://www.studio4net.com');
define('SKT_THEME_DOC','http://www.studio4net.com/documentation/skt_hotel_doc/');
define('SKT_PRO_THEME_URL','http://www.studio4net.com');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/');



function hotel_credit(){
		return "&copy; ".date('Y')." 35 OnWashington. All Rights Reserved";
}
function hotel_themebytext(){
		return "Web by <a href=".esc_url(SKT_URL)." target='_blank'>Studio4net</a>";
}
/**
